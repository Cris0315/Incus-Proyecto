...
La comunicación interna entre contenedores se realiza mediante una red privada administrada por Incus sobre la subred: 10.10.0.0/24
...
El usuario accede desde el navegador web.
La solicitud es recibida por la aplicación Flask.
La lógica de negocio procesa la reserva.
